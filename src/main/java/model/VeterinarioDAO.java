...
// CRUD    
    public Veterinario create(String nome, String end, String telefone) {
        try {
            PreparedStatement stmt;
            stmt = DAO.getConnection().prepareStatement("INSERT INTO veterinario (nome, end, telefone) VALUES (?,?,?)");
    ...
    private Veterinario buildObject(ResultSet rs) {
        ...
        try {
            veterinario = new Veterinario(rs.getInt("id"), rs.getString("nome"), rs.getString("end"), rs.getString("telefone"));
    ...
    public void update(Veterinario veterinario) {
        try {
            PreparedStatement stmt;
            stmt = DAO.getConnection().prepareStatement("UPDATE veterinario SET nome=?, end=?, telefone=? WHERE id=?");
